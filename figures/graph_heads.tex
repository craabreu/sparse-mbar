...
(1) edge [bend right, draw=blue] node[left] {} (2)
    edge [loop above, draw=red] node {} (1)
(2) edge [draw=red] node [right] {} (1)
    edge [draw=cyan] node {} (4)
    edge [loop left, draw=blue] node {} (2)
    edge [bend right, draw=orange] node[left] {} (3)
(3) edge [draw=blue] node [right] {} (2)
    edge [bend right, draw=cyan] node[right] {} (4)
    edge [loop below, draw=orange] node {} (3)
(4) edge [draw=orange] node [left] {} (3)
